        ...
        {isLoading ? (
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-muted-foreground">Devise préférée</label>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-muted-foreground">Langue</label>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-muted-foreground">Avatar (URL, facultatif)</label>
            ...
            {succes && <p className="text-sm text-forest-600 dark:text-forest-400 text-center font-semibold">Profil mis à jour.</p>}

            <div className="pt-2 flex gap-3">
              <button type="button" onClick={onClose} className="flex-1 py-3 px-4 rounded-xl border border-border text-sm font-semibold hover:bg-muted">Fermer</button>
