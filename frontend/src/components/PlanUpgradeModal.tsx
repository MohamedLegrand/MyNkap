  ...
  return (
    <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-card w-full max-w-lg rounded-2xl border border-border shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
        ...
        {/* max-h-[90vh]+overflow-y-auto : le formulaire (plan, cycle,
            méthode de paiement, pays/opérateur/téléphone) dépasse la
            hauteur d'écran sur de petits viewports — même correctif que
            RechargeCompteModal. */}
